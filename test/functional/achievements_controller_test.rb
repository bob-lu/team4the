...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { is_single_point: @achievement.is_single_point, name: @achievement.name, point: @achievement.point }
    end
  ...
  test "should update achievement" do
    put :update, id: @achievement, achievement: { is_single_point: @achievement.is_single_point, name: @achievement.name, point: @achievement.point }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
